...
function SectionHeader({
    ...
    return (
        <FadeIn style={{ width: "100%", maxWidth: "72rem", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", marginBottom: "4rem" }}>
            ...
            <h2 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, color: TEXT, marginBottom: "1.25rem", lineHeight: 1.1 }}>
                {title}
            </h2>
            {subtitle && (
                <p style={{ color: MUTED, maxWidth: "36rem", fontSize: "1rem", lineHeight: 1.75 }}>{subtitle}</p>
            )}
        </FadeIn>
    );
}
...
function PriceTable({ prices }: { prices: number[] }) {
    return (
        <div style={{ borderTop: SECTION_BORDER, marginTop: "1.25rem", paddingTop: "1.25rem" }}>
            <p style={{ color: ICE, fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
                Pricing
            </p>
...
const allPackages = [
    {
        ...
        label: "Full Interior & Exterior Detail",
    ...
    },
    {
        ...
        services: [
            ...
            "Clay bar treatment",
            "IceLux Shield protection",
            "Exterior trim restoration",
            "Interior dressing",
            "Engine bay detail",
        ],
        prices: [230, 280, 330, 380, 450],
        warning: null,
    },
    {
        id: "luxe-refresh",
    ...
    },
    {
        ...
        prices: [85, 110, 135, 155, 180],
        warning: null,
    },
];

/* ─── Paint protection data ──────────────────────────────────── */
const paintProtection = [
    ...
    },
    {
        ...
        durability: "Up to 5 Months",
        isSale: false,
        flashSale: null,
        regularPrice: null,
        pricing: [
            { label: "Cars, SUVs & Trucks", price: "$50" },
            { label: "3rd Row SUVs", price: "$60" },
            { label: "Sprinter Vans", price: "$75" },
        ],
    },
    {
        Icon: Sparkles,
        ...
        regularPrice: null,
        pricing: [
            { label: "Cars, SUVs & Trucks", price: "$75" },
            { label: "3rd Row SUVs", price: "$85" },
            { label: "Sprinter Vans", price: "$100" },
        ],
    },
];
...
const signatureEnhancements = [
    { Icon: LeatherIcon,      name: "Leather Treatment",         description: "Nourishes leather, restores softness, and protects against drying and cracking.",                              durability: "Up to 3 Months",  price: "$40" },
    { Icon: RubberMatIcon,    name: "Rubber Mat Renewal",        description: "Restores faded rubber floor mats to a clean, factory-fresh appearance with UV protection.",                    durability: "Up to 2 Months",  price: "$35" },
    { Icon: TrimRestoreIcon,  name: "Black Trim Restoration",    description: "Restores faded exterior plastic trim to a rich, deep-black appearance with long-lasting UV protection.",       durability: "6–12 Months",     price: "$40" },
    ...
    return (
        <>
            ...
            <section style={{ position: "relative", background: BG, overflow: "hidden" }}>
                <div
                    aria-hidden
                    style={{ position: "absolute", inset: 0, pointerEvents: "none", background: "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(11,191,255,0.07) 0%, transparent 70%)" }}
                />
                <div style={{ position: "relative", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "6rem 2rem 5rem" }}>
                    <p style={{ color: ICE, fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", marginBottom: "1rem", ...heroAnim(100) }}>
                        IceLux Services
                    </p>
                    <h1 style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(2.5rem,6vw,4rem)", fontWeight: 700, color: TEXT, marginBottom: "1.25rem", lineHeight: 1.05, ...heroAnim(200) }}>
                        Detailing Packages
                    </h1>
                    <p style={{ color: MUTED, fontSize: "1.0625rem", maxWidth: "34rem", lineHeight: 1.75, ...heroAnim(320) }}>
            ...
            <section style={{ background: BG, borderTop: SECTION_BORDER, paddingTop: "1rem", paddingBottom: "6rem" }}>
                <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", padding: "0 2rem" }}>
                    <div style={{ width: "100%", maxWidth: "72rem", display: "grid", gap: "1.75rem", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))" }}>
                        {allPackages.map((pkg, i) => (
                            <FadeIn key={pkg.id} delay={i * 80} style={{ display: "flex" }}>
                                <div style={{
                                    position: "relative",
                                    background: pkg.featured ? "#0A1A2E" : BG3,
                                    border: pkg.featured ? BORDER_GLOW : BORDER,
                                    boxShadow: pkg.featured ? "0 0 50px rgba(11,191,255,0.10)" : "none",
                                    borderRadius: "1rem",
                                    padding: "2rem",
                                    display: "flex",
                    ...
                    <span style={{ ...pkg.badgeStyle, fontSize: "0.625rem", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", padding: "0.3rem 0.75rem", borderRadius: "9999px", display: "inline-block" }}>
                      {pkg.badge}
                    </span>
                                    </div>

                                    <h2 style={{ fontFamily: FONT_DISPLAY, color: TEXT, fontSize: "1.5rem", fontWeight: 700, marginBottom: "0.375rem" }}>
                                        {pkg.name}
                                    </h2>
                                    ...
                                    <Link
                                        href="/contact"
                                        className={pkg.featured ? "btn-ice" : "btn-outline-ice"}
            ...
            <section style={{ position: "relative", background: BG, borderTop: SECTION_BORDER, padding: "7rem 2rem", overflow: "hidden" }}>
                ...
                <FadeIn style={{ position: "relative", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                    <p style={{ color: ICE, fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", marginBottom: "1.25rem" }}>
                        Get Started
                    </p>
