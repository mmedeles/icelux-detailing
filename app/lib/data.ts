// IceLux Detailing — Static Content

export const siteConfig = {
  name: "IceLux Detailing",
  tagline: "From Dusty to Icy",
  phone: "725-221-9148",
...
export const featuredPackages = [
  {
    ...
    badge: "Most Popular",
    description: "The complete IceLux experience — full interior restoration and exterior detail in one session.",
    highlights: [
      "Full interior deep clean",
      "Exterior hand wash & clay bar",
      "Tire dressing & trim wipe",
      "Interior plastics conditioned",
  ...
  },
  {
    ...
    badge: "Premium",
    description: "A step above — enhanced paint correction and premium interior treatment for the true enthusiast.",
    highlights: [
      "Everything in Signature",
      "Paint correction (single stage)",
      "Leather conditioning",
      "Engine bay dress",
      "Ceramic protective wash",
    ],
    cta: "View Full Details",
  },
  {
...
export const packages = [
  {
    ...
    services: [
      ...
      "Plastics & trim conditioning",
      "Glass cleaned inside & out",
      "Exterior hand wash & rinse",
      "Clay bar decontamination",
      "Tire dressing & wheel cleaning",
      "Exterior plastic trim wipe",
      "Door jamb cleaning",
    ],
    note: "Pricing varies based on vehicle size. Contact for a quote.",
  },
  {
    id: "diamond-luxe",
  ...
  },
  {
    ...
    note: "This is an elite-tier package. Pricing based on vehicle condition and size.",
    featured: true,
  },
  {
    id: "blue-diamond",
  ...
  },
  {
    ...
    note: "Best for vehicles on a monthly maintenance plan.",
  },
];
...
export const trustBarItems = [
  ...
  { label: "Premium Products", sub: "Professional grade" },
  { label: "Flexible Scheduling", sub: "Book on your time" },
  { label: "Detail-Focused Finish", sub: "No shortcuts" },
];
